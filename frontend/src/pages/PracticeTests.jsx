            ...
            <div className="p-6">
                ...
                <div className="grid grid-cols-3 gap-2 mb-4">
                    <div className="text-center bg-slate-50 rounded-xl py-2.5">
                        <p className="font-bold text-slate-800">{test.questionCount || 0}</p>
                        <p className="text-xs text-slate-400">Questions</p>
                    </div>
                    <div className="text-center bg-slate-50 rounded-xl py-2.5">
                        <p className="font-bold text-slate-800">{totalMarks}</p>
                        <p className="text-xs text-slate-400">Marks</p>
                    </div>
                    <div className="text-center bg-slate-50 rounded-xl py-2.5">
                        <p className="font-bold text-slate-800">{test.timeLimit > 0 ? `${test.timeLimit}m` : '∞'}</p>
                ...
                <div className="flex items-center justify-between">
                    ...
                    <Link
                        ...
                        className="text-xs font-semibold text-white bg-violet-600 hover:bg-violet-700 px-3 py-1.5 rounded-xl transition flex items-center gap-1">
                        View →
                    </Link>
                </div>
            </div>
    ...
    return (
        <Layout>
            <div className="max-w-7xl mx-auto px-4 py-8 space-y-8">
                {/* Hero */}
                <div className="relative overflow-hidden rounded-3xl bg-gradient-to-br from-violet-600 via-indigo-600 to-blue-700 text-white p-8 md:p-12">
